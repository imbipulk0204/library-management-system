...
<div class="container">
    ...
    <div class="issues p-5 ">
        <h1 class="text-">All ISSUES</h1>
        <hr class="bg-dark pt-1 w-75 ml-0">
        <div class="list-group">
        <?php
            $sql = "select * from issue i join books b on i.book_id = b.isbn join user u on i.user_id = u.id where status = 1";
        ...
        ?>
            <div class="list-group-item">
                    <div class="row m-0">
                        ...
                        <div class="col">
                            <a href="return.php?issue_id=<?php echo $issue_id?>" class=" w-100 btn btn-success">Return</a>
                        </div>
                    </div>
            </div>
        <?php }} else{?>
